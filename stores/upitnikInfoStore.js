...
import { local_url, getTotalAnsweredQuestions, getAnsweredQuestionsForGroup } from '~/services/services';
    ...
    actions: {
        ...
        async initializeStore() {
            if(!import.meta.env.SSR){
                const response = await fetch(`${local_url}/get-upitnik-cookies`, {
                    method: 'GET',
                    credentials: 'include'
                });
                ...
                this.evu_sif = cookies.evu_sif;
                this.ezu_ess_id = cookies.ezu_ess_id;
                this.ezu_id = cookies.ezu_id;
                this.ezu_ezp_id = cookies.ezu_ezp_id;
                // this.ess_id = cookies.ess_id;
                this.ezu_naziv = cookies.ezu_naziv;
                // this.ezu_mijenjao = cookies.ezu_mijenjao;
                // this.finished = cookies.finished;
            }
        ...
        async setUpitnikInfo(upitnikInfo){
            console.log("setUpitnikInfo: ", upitnikInfo);
            await fetch(`${local_url}/set-upitnik-cookies`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
                },
                body: JSON.stringify(upitnikInfo)
            })
        },
        // setEvuSif(evu_sif) {
        ...
        async clearUpitnikInfo(){
            ...
            await fetch(`${local_url}/clear-upitnik-cookies`, { 
                method: 'POST',
                credentials: 'include'
            });
